...
import com.example.tetrisgame.presenter.GameStatus;
import com.example.tetrisgame.presenter.GameView;
...
public class GameViewImpl implements GameView {
    ...
    @Override
    public void init(int gameSize) { mGameFrame.init(gameSize); }
