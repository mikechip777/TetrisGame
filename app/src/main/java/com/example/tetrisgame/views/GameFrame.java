...
import com.example.tetrisgame.presenter.Point;

public class GameFrame extends View {

    public GameFrame(Context context) { super(context); }

    public GameFrame(Context context, @Nullable AttributeSet attrs) { super(context, attrs); }
    ...
    void setPoints(Point[][] points) { mPoints = points; }

    private Point getPoint(int x, int y) { return mPoints[x][y]; }
