...
public class GamePresenter {
    ...
    public void setGameModel(GameModel gameModel) { mGameModel = gameModel; }

    public void setGameView(GameView gameView) { mGameView = gameView; }
    ...
    public void turn(GameTurn turn) { mGameModel.turn(turn); }
